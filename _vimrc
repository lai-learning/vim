...
" map ctrl + s to fast saving in normal mode
map <C-s> :w<CR>

" map ctrl + s to fast saving in insert mode
imap <C-s> <Esc>:w<CR>a
...
"autocmd BufNewFile *.c,*.cpp,*.[ch],*.sh,*.perl,*.v,*.matlab exec ":call SetTitle()" 
...
"        call append(line(".")+2, "\# ") 
"        call append(line(".")+3, "\# ") 
"        call append(line(".")+4, "\# Author: hujianlai") 
"        call append(line(".")+5, "\# Created Time: ".strftime("%c")) 
"        call append(line(".")+6, "\###############################################################") 
"        call append(line(".")+7, "") 
"        call append(line(".")+8, "\#!/usr/bin/perl") 
"        call append(line(".")+9, "") 
"    else 
"        call setline(1, "\/*****************************************************/") 
"        call append(line("."), "\/\/File  Name  : ".expand("%")) 
"        call append(line(".")+1, "\/\/Discription : ") 
"        call append(line(".")+2, "\/\/Author      : hujianlai") 
...
if g:isGUI
    ...
    winpos 300 100                                     "指定窗口出现的位置，坐标原点在屏幕左上角
    set lines=25 columns=70                          "指定窗口大小，lines为高度，columns为宽度
endif
